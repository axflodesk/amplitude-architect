...
// Stop/Cancel icon
export const IconStop: React.FC<IconProps> = ({ width = 24, height = 24, className, style }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width={width} height={height} className={className} style={style}>
